<%@ Page Title="" Language="C#" MasterPageFile="~/houtai/MasterPage.master" AutoEventWireup="true" CodeFile="OrderManage.aspx.cs" Inherits="OrderManage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <h4 style="font-weight:bold">订单信息管理</h4>
                                ...
                                <tr class="timeline">
                                    ...
                                    <td class="ordertimeline-handle" style="width:150px">
                                        ...
                                        <asp:PlaceHolder ID="PlaceHolder2" runat="server" Visible="false">
                                            <asp:LinkButton ID="Send" class="btn-danger" style="width:78px;height:26px;text-decoration:none;" runat="server" CommandName="SendFaHuo">确认发货</asp:LinkButton>
                                            <br />
                                            <br />
