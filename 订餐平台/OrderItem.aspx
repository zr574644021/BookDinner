<%@ Page Title="Contact" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="OrderItem.aspx.cs" Inherits="OrderItem" %>
                                ...
                                <div class="orderprogress-status ng-scope">
                                    ...
                                    <%# Eval("收货状态").ToString() == "已完成" ?
                                            ...
                                            "<div class='orderprogress-statusbuttons'>"+
                                                "<a href='#'  class='ng-binding ng-scope linktype'>申请退单(未开发)</a>"+       
                                                "<a href='#'  class='ng-binding ng-scope linktype'>再来一单(未开发)</a>"+
                                            "</div>":"" %>
                                    <%# Eval("收货状态").ToString() == "未发货" ?
                                   ...
                                   <asp:PlaceHolder ID="PlaceHolder2" runat="server" Visible="false">
                                    ...
                                    <asp:PlaceHolder ID="PlaceHolder1" runat="server" Visible="false">
                                        <div class="orderprogress-statusbuttons">
                                            <asp:LinkButton ID="Exit"  class="btn btn-danger" runat="server" CommandName="Exit">退单</asp:LinkButton>
                                        </div>
                                    </asp:PlaceHolder>
